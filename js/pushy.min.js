! function(a) {
    ...
    function f() {
        a(r).addClass(t), u.children("a").on("click", function(b) {
            b.preventDefault(), a(this).toggleClass(s).next(".pmenu-submenu ul").slideToggle(200).end().parent(r).siblings(r).children("a").removeClass(s).next(".pmenu-submenu ul").slideUp(200)
        })
    }
    var g = a(".pmenu"),
        h = a("body"),
        ...
        m = "pmenu-open-right",
        n = a(".site-overlay"),
        o = a(".menu-btn, .pmenu-link"),
        p = 200,
        q = g.width() + "px",
        r = ".pmenu-submenu",
        s = "pmenu-submenu-open",
        t = "pmenu-submenu-closed",
        u = a(r),
        v = function() {
